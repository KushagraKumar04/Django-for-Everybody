# Graded Assessments 1
# Exploring the HyperText Transfer Protocol

Steps:

1. Open your browser and go to the URL: http://data.pr4e.org/intro-short.txt. or the given url in assignment.
...
5. Locate the following headers and copy their values:
